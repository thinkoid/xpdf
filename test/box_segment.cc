...
static const std::vector< std::tuple< xpdf::bbox_t, xpdf::bbox_t > >
    normalize_dataset = { { { 1, 2, 0, 4 }, { 0, 2, 1, 4 } },
                          { { 1, 4, 0, 2 }, { 0, 2, 1, 4 } },
                          { { 0, 4, 1, 2 }, { 0, 2, 1, 4 } } };

BOOST_DATA_TEST_CASE(normalize_, data::make(normalize_dataset), box, result)
{
...
static const std::vector< std::tuple< xpdf::bbox_t, xpdf::bbox_t, double > >
    horizontal_overlap_dataset = { { { 10, 5, 20, 10 }, { 30, 15, 40, 20 }, 0 },
...
BOOST_DATA_TEST_CASE(horizontal_overlap_, data::make(horizontal_overlap_dataset),
                     lhs, rhs, result)
{
    using namespace xpdf;
...
BOOST_DATA_TEST_CASE(vertical_overlap_, data::make(vertical_overlap_dataset), lhs,
                     rhs, result)
{
    using namespace xpdf;
...
BOOST_DATA_TEST_CASE(horizontal_distance_,
                     data::make(horizontal_distance_dataset), lhs, rhs, result)
{
    using namespace xpdf;
...
BOOST_DATA_TEST_CASE(vertical_distance_, data::make(vertical_distance_dataset),
                     lhs, rhs, result)
{
    using namespace xpdf;

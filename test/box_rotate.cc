...
static const std::vector< std::tuple< xpdf::bboxi_t, xpdf::bboxi_t, xpdf::bboxi_t,
                                      xpdf::bboxi_t, xpdf::bboxi_t > >
    rotate_dataset{ { { 20, 400, 80, 600 },
                      { 0, 0, 200, 800 },
                      { 400, 120, 600, 180 },
                      { 120, 200, 180, 400 },
                      { 200, 20, 400, 80 } } };

BOOST_DATA_TEST_CASE(rotate_, data::make(rotate_dataset), box, superbox, result90,
                     result180, result270)
{

...
public:
    ...
    void resetToRect(SplashCoord x0, SplashCoord y0, SplashCoord x1,
                     SplashCoord y1);
    ...
    SplashClipResult testRect(int rectXMin, int rectYMin, int rectXMax,
    ...
    bool clipSpanBinary(unsigned char *line, int y, int x0, int x1,
                        bool strokeAdjust);

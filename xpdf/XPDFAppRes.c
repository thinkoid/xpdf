...
#define T(a, b, type, other, mb, ptr) \
    { a, b, type, sizeof (other), XtOffsetOf (struct XPDFAppResources, mb), type, (XtPointer)ptr }
    ...
    T ("reverseVideo",         "ReverseVideo",         XtRBool,   Bool,   reverseVideo,         &defReverseVideo),
    T ("paperColor",           "PaperColor",           XtRString, String, paperColor,           0),
    T ("matteColor",           "MatteColor",           XtRString, String, matteColor,           "gray50"),
    T ("fullScreenMatteColor", "FullScreenMatteColor", XtRString, String, fullScreenMatteColor, "black"),

...
public:
    ...
    SplashOutputDev (
        ...
        SplashColorPtr paperColorA, GBool bitmapTopDownA = gTrue,
...
private:
    ...
    SplashPath*
    convertPath (GfxState* state, GfxPath* path, GBool dropEmptySubpaths);
    ...
    static GBool
    imageSrc (void* data, SplashColorPtr colorLine, Guchar* alphaLine);
    static GBool
    alphaImageSrc (void* data, SplashColorPtr line, Guchar* alphaLine);
    static GBool
    maskedImageSrc (void* data, SplashColorPtr line, Guchar* alphaLine);
    void

...
public:
    ...
    PSOutputDev(const char *fileName, PDFDoc *docA, int firstPage, int lastPage,
                PSOutMode modeA, int imgLLXA = 0, int imgLLYA = 0,
                int imgURXA = 0, int imgURYA = 0, bool manualCtrlA = false,
                PSOutCustomCodeCbk customCodeCbkA = NULL,
                void *             customCodeCbkDataA = NULL);

    // Open a PSOutputDev that will write to a generic stream.
    PSOutputDev(PSOutputFunc outputFuncA, void *outputStreamA, PDFDoc *docA,
    ...
    void writeHeader(int firstPage, int lastPage, PDFRectangle *mediaBox,
    ...
    virtual bool checkPageSlice(Page *page, double hDPI, double vDPI, int rotate,
                                bool useMediaBox, bool crop, int sliceX,
                                int sliceY, int sliceW, int sliceH, bool printing,
...
private:
    void init(PSOutputFunc outputFuncA, void *outputStreamA, PSFileType fileTypeA,
              PDFDoc *docA, int firstPage, int lastPage, PSOutMode modeA,
    ...
    PSFontFileInfo *setupExternalCIDTrueTypeFont(GfxFont *font, GString *fileName,
                                                 int  fontNum,
                                                 bool needVerticalMetrics);
    ...
    void opiTransform(GfxState *state, double x0, double y0, double *x1,
                      double *y1);
    ...
    void *overlayCbkData;
    GString *(*customCodeCbk)(PSOutputDev *psOut, PSOutCustomCodeLocation loc,
                              int n, void *data);

...
typedef struct {
   ...
   */
    XpdfBool (*newDoc) (
        void* handlerData, XpdfDoc doc, XpdfObject encryptDict, void** docData);
   ...
   */
    XpdfBool (*makeAuthData) (
        void* handlerData, void* docData, char* ownerPassword,
        char* userPassword, void** authData);
   ...
   * successful.
   */
    XpdfBool (*getAuthData) (void* handlerData, void* docData, void** authData);

    /*
   * Free the data allocated by getAuthData.
   */
    void (*freeAuthData) (void* handlerData, void* docData, void* authData);

    /*
   * Request permission to access the document.  This returns all
   * permissions granted by authData.
   */
    XpdfPermission (*authorize) (
        void* handlerData, void* docData, void* authData);
   ...
   */
    XpdfBool (*getKey) (
        void* handlerData, void* docData, char** key, int* keyLen,
        int* cryptVersion);

    /*
   * Free the data allocated by getKey.
   */
    void (*freeKey) (void* handlerData, void* docData, char* key, int keyLen);
...
#define xpdfRegisterSecurityHandler \
    (*xpdfPluginVecTable._xpdfRegisterSecurityHandler)

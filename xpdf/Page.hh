...
public:
    ...
    {
        return lastModified.is_string() ? lastModified.as_string() :
                                          (GString *)NULL;
    }
...
public:
    ...
    void makeBox(double hDPI, double vDPI, int rotate, bool useMediaBox,
    ...
    void getDefaultCTM(double *ctm, double hDPI, double vDPI, int rotate,

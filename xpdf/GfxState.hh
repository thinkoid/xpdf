...
public:
    ...
    virtual void
    getDefaultRanges (double* decodeLow, double* decodeRange, int maxImgPixel);
...
private:
    GfxTilingPattern (
        ...
        double yStepA, Object* resDictA, double* matrixA,
...
public:
    ...
    void getCoords (
        double* x0A, double* y0A, double* r0A, double* x1A, double* y1A,
        double* r1A) {
        *x0A = x0;
        *y0A = y0;
        *r0A = r0;
...
public:
    ...
    static GfxGouraudTriangleShading*
    parse (int typeA, Dict* dict, Stream* str);
...
public:
    ...
    void
    getUserClipBBox (double* xMin, double* yMin, double* xMax, double* yMax);
    ...
    void
    setTextMat (double a, double b, double c, double d, double e, double f) {
        textMat[0] = a;
        textMat[1] = b;
        textMat[2] = c;
        textMat[3] = d;

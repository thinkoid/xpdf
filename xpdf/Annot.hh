...
{
public:
    AnnotBorderStyle(AnnotBorderType typeA, double widthA, double *dashA,
                     int dashLengthA, double *colorA, int nColorCompsA);
    ~AnnotBorderStyle();
...
public:
    ...
    bool match(Ref *refA) { return ref.num == refA->num && ref.gen == refA->gen; }
...
private:
    ...
    void adjustLineEndpoint(AnnotLineEndType lineEnd, double x, double y,
                            double dx, double dy, double w, double *tx,
                            double *ty);
    void drawLineArrow(AnnotLineEndType lineEnd, double x, double y, double dx,

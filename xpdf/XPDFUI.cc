...
XPDFUICmd XPDFUI::cmdTab [] = {
    ...
    { "followLinkInNewWinNoSel", 0,   true,   true, &XPDFUI::cmdFollowLinkInNewWinNoSel },
    ...
    { "openFileAtDestInNewWin",  2,  false,  false, &XPDFUI::cmdOpenFileAtDestInNewWin  },
    { "openFileAtPage",          2,  false,  false, &XPDFUI::cmdOpenFileAtPage          },
    { "openFileAtPageInNewWin",  2,  false,  false, &XPDFUI::cmdOpenFileAtPageInNewWin  },

...
public:
    ...
    static bool makeFileKey(int encVersion, int encRevision, int keyLength,
                            ...
                            GString *ownerEnc, GString *userEnc, int permissions,
                            GString *fileID, GString *ownerPassword,
                            GString *userPassword, unsigned char *fileKey,
                            bool encryptMetadata, bool *ownerPasswordOk);

private:
    static void r6Hash(unsigned char *key, int keyLen, const char *pwd,
                       int pwdLen, const char *userKey);
...
extern unsigned char rc4DecryptByte(unsigned char *state, unsigned char *x,
...
extern void          aesKeyExpansion(DecryptAESState *s, unsigned char *objKey,
                                     int objKeyLen, bool decrypt);

...
template< typename T, typename... U > inline bool contains(T &&t, U &&... u)
{
    return ((t == u) || ...);
}

template< typename T > inline T as(Dict &dict, const char *s)
{
    return dict.at(s).cast< T >();
}

template< typename T > inline T array_get(Object &arr, size_t i)
{
    return arr[i].cast< T >();
}

template< typename T > inline auto as_array(Object &obj)
{
...
template<> inline auto as_array< size_t >(Object &obj)
{
    auto &src = obj.as_array();
...
template<> inline auto as_array< std::tuple< double, double > >(Object &obj)
{
...
template< typename T > inline auto as_array(Dict &dict, const char *s)
{
...
template< typename T > std::vector< T > maybe_array(Dict &dict, const char *s)
{
    auto obj = resolve(dict[s]);

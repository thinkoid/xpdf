...
Unicode *OptionalContentGroup::as_name()
{
...
OCDisplayNode *OCDisplayNode::parse(Object *obj, OptionalContent *oc, XRef *xref,
                                    int recursion)
{
    Object                obj2, obj3;
    Ref                   ref;
